...
from optimum.onnxruntime import ORTModelForCausalLM, ORTModelForSequenceClassification, ORTModel
...
class DistributedBloomONNXModel(FromPretrainedMixin, PTuneMixin, ORTModel):
    ...
    def __init__(self, config: DistributedBloomONNXConfig, *, dht: Optional[hivemind.DHT] = None):
...
class DistributedBloomONNXForCausalLM(FromPretrainedMixin, RemoteGenerationMixin, ORTModelForCausalLM):
    _keys_to_ignore_on_load_missing = DistributedBloomONNXModel._keys_to_ignore_on_load_missing
    _keys_to_ignore_on_load_missing += [r"^lm_head\."]  # Missing since they are shared with input embeddings
    _keys_to_ignore_on_load_unexpected = DistributedBloomONNXModel._keys_to_ignore_on_load_unexpected
...
class DistributedBloomONNXForSequenceClassification(FromPretrainedMixin, ORTModelForSequenceClassification):
    _keys_to_ignore_on_load_missing = DistributedBloomONNXModel._keys_to_ignore_on_load_missing
    _keys_to_ignore_on_load_unexpected = DistributedBloomONNXModel._keys_to_ignore_on_load_unexpected
